...
export const VenerableContributorStatusSkeletonLoader = () => {
  return (
...
const VenerableMetricCardSkeleton = () => {
  return (
    <Card
      radius={5}
    ...
    >
      <Group justify="space-between" align="flex-start">
        ...
        <CircleChurchIcon className="size-[18px] md:size-[35px]" />
      </Group>
    </Card>
  );
};

const VenerableOverviewSkeletonLoader = () => {
  return (
    <SimpleGrid className="grid-cols-2 gap-2 sm:gap-x-4 md:grid-cols-3 xl:grid-cols-4 xl:gap-x-4">
      <Repeater count={4}>
        <VenerableMetricCardSkeleton />
      </Repeater>
    </SimpleGrid>
  );
};

export default VenerableOverviewSkeletonLoader;
