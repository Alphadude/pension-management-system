...
export const AccountantContributorStatusSkeletonLoader = () => {
  return (
...
const AccountantMetricCardSkeleton = () => {
  return (
    <Card
      radius={5}
...
const AccountantOverviewSkeletonLoader = () => {
  return (
    <SimpleGrid className="grid-cols-2 gap-2 sm:gap-x-4 md:grid-cols-3 xl:grid-cols-4 xl:gap-x-4">
      <Repeater count={4}>
        <AccountantMetricCardSkeleton />
      </Repeater>
    </SimpleGrid>
  );
};

export default AccountantOverviewSkeletonLoader;
