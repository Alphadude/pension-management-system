          ...
          <Menu.Dropdown>
            ...
            <Menu.Item>
              <Group className="h-[25px] bg-transparent px-2 py-1 text-sm font-normal text-[#1E1E1E]">
                ...
                <Link
                  href={
                    routes.accountantDashboard.pensionManagement +
        ...
        <Box className="mb-4 flex w-full items-start justify-between">
          ...
          <Box className="flex flex-col items-start gap-1">
            <Box
              ...
              onClick={() =>
                router.push(
                  `/accountant-dashboard/pension-management/${dioceseId}`,
                )
              }
          ...
          <Box className="flex items-center gap-3">
            ...
            <Button
              ...
              href={
                data?.doc?.[0]
                  ? `${routes.accountantDashboard.pensionManagement}/${dioceseId}/${parishId}/${data.doc[0]._id}/enter-pension`
                  : "#"
              }
              color="blue"
              radius="md"
