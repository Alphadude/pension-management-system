...
import { serviceEmail } from "@/lib/utils";
...
const SupportPageClient = () => {
  ...
  const handleSubmitForm = async () => {
    const subject = encodeURIComponent(form.values.subject);
    const body = encodeURIComponent(form.values.message);

    const gmailUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=${serviceEmail}&su=${subject}&body=${body}`;
