...
export const ParishContributorStatusSkeletonLoader = () => {
  return (
...
const ParishMetricCardSkeleton = () => {
  return (
    <Card
      radius={5}
...
const ParishOverviewSkeletonLoader = () => {
  return (
    <SimpleGrid className="grid-cols-2 gap-2 sm:gap-x-4 md:grid-cols-3 xl:grid-cols-4 xl:gap-x-4">
      <Repeater count={4}>
        <ParishMetricCardSkeleton />
      </Repeater>
    </SimpleGrid>
  );
};

export default ParishOverviewSkeletonLoader;
