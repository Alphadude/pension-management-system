...
const ConfirmationModal = ({
  ...
  recipients = "ABC Diocese",
  totalContributors = 6,
  totalContribution = "₦50,000.00",
  parishAddition = "₦100,000.00",
  toDiocese = "₦150,000.00",
  onSubmit,
  ...
  return (
    ...
    >
      <Stack gap={24}>
        ...
        <Button onClick={onSubmit}>Confirm & Submit Monthly Remittance</Button>
      </Stack>
    </Modal>
  );
};
