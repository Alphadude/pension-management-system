...
export const DioceseContributorStatusSkeletonLoader = () => {
  return (
...
const DioceseMetricCardSkeleton = () => {
  return (
    <Card
      radius={5}
...
const DioceseOverviewSkeletonLoader = () => {
  return (
    <SimpleGrid className="grid-cols-2 gap-2 sm:gap-x-4 md:grid-cols-3 xl:grid-cols-4 xl:gap-x-4">
      <Repeater count={4}>
        <DioceseMetricCardSkeleton />
      </Repeater>
    </SimpleGrid>
  );
};

export default DioceseOverviewSkeletonLoader;
